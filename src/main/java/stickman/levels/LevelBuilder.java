...
public abstract class LevelBuilder {
    ...
    protected long levelExpectFinishTime;
    ...
    public Level getLevel() {
        return new LevelImp(entities, hero, bg_drawer, levelExpectFinishTime, lastLevel);
    }
    ...
    protected void buildScoreTracker() { return; }
